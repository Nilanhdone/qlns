        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data" id="register">
            ...
            <!-- Unit -->
              <div class="form-group row">
                ...
                <div class="col-md-8">
                    <select class="btn border-primary" name="unit" form="register">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <select class="btn border-primary" name="position" form="register">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    <select class="btn border-primary" name="role" form="register">
